...
class CoordinateEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('nom', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Lastname', 'label_attr' => ['class' => 'form-label mt-4'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('prenom', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Firstname', 'label_attr' => ['class' => 'form-label mt-2'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('pseudo', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Pseudo', 'label_attr' => ['class' => 'form-label mt-2'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('address', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Address', 'label_attr' => ['class' => 'form-label mt-2'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('zip', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Zip', 'label_attr' => ['class' => 'form-label mt-2'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('city', TextType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'City', 'label_attr' => ['class' => 'form-label mt-2'],
                'constraints' => [
                    new Sequentially([
            ...
            ->add('phone', TelType::class, [
                'attr' => ['class' => 'form-control'], 'label' => 'Phone', 'label_attr' => ['class' => 'form-label mt-2 mb-2'],
                'constraints' => [
                    new Sequentially([
